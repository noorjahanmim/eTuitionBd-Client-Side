...
//     const userInfo = {
//       email: data.email,
//       name: data.name, // ✅ keep consistent with DB
//       role: data.role.charAt(0).toUpperCase() + data.role.slice(1).toLowerCase(), // ✅ normalize
//       phone: data.phone,
//       photoUrl: data.photoURL || "", // ✅ match DB field
//       // status: "Active",
//       createdAt: new Date()
//     };
...
// Optional delay to ensure Firebase syncs
